...
import fragShader from "../shaders/tunnel.frag";
  ...
  uniforms = {
    ...
    uChannel0: {
      value: new THREE.TextureLoader().load(
        new URL("../assets/texture1.jpeg", import.meta.url).href
      ),
    },
    uChannel1: {
      value: new THREE.TextureLoader().load(
        new URL("../assets/texture2.jpeg", import.meta.url).href
      ),
    },
  };

  // Setting up texture wrapping to repeat forever.
  uniforms.uChannel0.value.wrapS = uniforms.uChannel0.value.wrapT =
    THREE.RepeatWrapping;
  uniforms.uChannel1.value.wrapS = uniforms.uChannel1.value.wrapT =
    THREE.RepeatWrapping;
